...
![Status](https://img.shields.io/badge/status-Wave%203%20(lean)-1a1a2e)
...
- [Your two jobs as a leader](#your-two-jobs-as-a-leader)
...
- **Executives, directors, and boards** setting the AI direction for an organisation.
- **Heads of department and change leads** who own adoption in practice.
- **Leaders in regulated or client-serving organisations** who carry the governance and literacy obligations, not just the upside.

## Your two jobs as a leader

You carry two stages at once: your *own*, and your *organisation's*. Confusing them is the classic mistake — an Integrator leader mandates a tool a Nomad workforce won't touch; a Nomad leader presides over ungoverned use they can't see. Diagnose both, because the fix differs in each direction. The [framework](framework/six-stages-for-leaders.md) covers how.

## The six stages, at org level

Every playbook in this series shares one diagnosis of where a person or organisation actually is — by how it feels, not by tools deployed:
...
> *"AI is the defining technology of our time. But its impact depends entirely on the clarity of your ambition."*
